...
import co.com.entity.Productos;
 ...
 */
@Stateless
@Path("co.com.entity.productos")
public class ProductosFacadeREST extends AbstractFacade<Productos> {

    @PersistenceContext(unitName = "REST_JPAPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Productos entity) {
        super.edit(entity);
    }
